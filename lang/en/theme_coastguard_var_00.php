...
$string['choosereadme'] = 'Coastguard Boost Var 00 is a modern highly-customisable theme. This theme is intended to be used directly, or as a parent theme when creating new themes utilising Bootstrap 4.';
$string['configtitle'] = 'Coastguard Boost Var 00';
$string['generalsettings'] = 'General settings';
$string['loginbackgroundimage'] = 'Login page background image';
$string['loginbackgroundimage_desc'] = 'The image to display as a background for the login page.';
$string['nobootswatch'] = 'None';
$string['pluginname'] = 'Coastguard Boost Var 00';
...
$string['privacy:metadata'] = 'The Coastguard Boost Var 00 theme does not store any personal data about any user.';
